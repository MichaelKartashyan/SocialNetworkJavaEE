                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="<%=user.getImagePath()%>" alt="Admin" class="" style="border-radius: 10px" width="150">
                                    <div class="mt-3">
                                        <h4><%=user.getName()%> <%=user.getSurname()%></h4>
                                        <p class="text-secondary mb-1"><b>О себе: </b> <%=user.getAbout()%></p>
...
<script type="text/javascript">
    function loadPosts(){
        ...
        $.ajax({
            url: "/ajaxReadPosts?id=<%=user.getId()%>",
